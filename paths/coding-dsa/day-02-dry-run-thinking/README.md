...
```bash
python scripts/kpos.py quiz --path coding-dsa --day 2 --score YOUR_SCORE --total 5
```
...
```bash
python scripts/kpos.py complete-day --path coding-dsa --day 2
```
